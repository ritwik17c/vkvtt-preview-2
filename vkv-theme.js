...
(function(){
  ...
  function mount(){
    ...
    if(/^annual-calendar-2026-27\.html$/i.test(page)&&!document.getElementById('vkvAnnualCalendarThemeHelper')){const s=document.createElement('script');s.id='vkvAnnualCalendarThemeHelper';s.src='./vkv-annual-calendar-theme.js?v=20260908-calendar-theme1';document.head.appendChild(s)}
  }
